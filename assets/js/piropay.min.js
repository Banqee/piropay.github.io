...
!function(e) {
    ...
    var s = /\+/g,
        a = e.cookie = function(r, s, l) {
            ...
            for (var p = r ? void 0 : {}, d = document.cookie ? document.cookie.split("; ") : [], h = 0, f = d.length; f > h; h++) {
                var m = d[h].split("="),
                    g = n(m.shift()),
                    v = m.join("=");
                if (r === g) {
...
function(e, t) {
    ...
    }, r.encode = d, r.decode = decodeURIComponent, r.iso8859 = function() {
        r.encode = escape, r.decode = unescape
    }, r.unicode = function() {
        r.encode = d, r.decode = decodeURIComponent
    }, r.characters = {
        pathname: {
            encode: {
    ...
    }, g.protocol = h("protocol"), g.username = h("username"), g.password = h("password"), g.hostname = h("hostname"), g.port = h("port"), g.query = f("query", "?"), g.fragment = f("fragment", "#"), g.search = function(e, t) {
...
+function(e) {
    ...
    n.VERSION = "3.3.7", n.TRANSITION_DURATION = 150, n.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (u) {
                ...
                a = "bottom" == a && c.bottom + d > f.bottom ? "top" : "top" == a && c.top - d < f.top ? "bottom" : "right" == a && c.right + p > f.width ? "left" : "left" == a && c.left - p < f.left ? "right" : a, o.removeClass(h).addClass(a)
            }
    ...
    function n(e, t, n, i) {
        var r = ["opacity", t, ~~(100 * e), n, i].join("-"),
            ...
            l = a && "-" + a + "-" || "";
        return p[r] || (d.insertRule("@" + l + "keyframes " + r + "{0%{opacity:" + s + "}" + o + "%{opacity:" + e + "}" + (o + .01) + "%{opacity:1}" + (o + t) % 100 + "%{opacity:" + e + "}100%{opacity:" + s + "}}", d.cssRules.length), p[r] = 1), r
    }
    function i(e, t) {
        var n,
            i,
            ...
            if (i.radius + i.length + i.width, r(o, {
                ...
                !function f() {
                    ...
                    for (var e = 0; e < i.lines; e++)
                        s = Math.max(1 - (a + (i.lines - e) * h) % p * d, i.opacity), n.opacity(o, e * i.direction + l, s, i);
...
function() {
            ...
            separator: function(n, i, r) {
                return n = n || " ", i = i || 3, r = r || "", function(o, s) {
                    var a = Math.floor(o).toString(),
                        l = e(s.elem);
                    if (a.length > i) {
                        for (var u, c, p, d = a, h = i, f = d.split("").reverse(), a = [], m = 0, g = Math.ceil(d.length / h); g > m; m++) {
                            for (u = "", p = 0; h > p && (c = m * h + p, c !== d.length); p++)
                                u += f[c];
                            a.push(u)
                        }
                        d = a.length - 1, h = t(a[d]), a[d] = t(parseInt(h, 10).toString()), a = a.join(n), a = t(a)
                    }
    ...
    return function(e, t) {
        ...
        var h = t || {},
            f = h.aggressive || !1,
            m = n(h.sensitivity, 20),
            g = n(h.timer, 1e3),
            v = n(h.delay, 0),
            y = h.callback || function() {},
            b = i(h.cookieExpire) || "",
            w = h.cookieDomain ? ";domain=" + h.cookieDomain : "",
            _ = h.cookieName ? h.cookieName : "viewedOuibounceModal",
            x = h.sitewide === !0 ? ";path=/" : "",
            k = null,
    ...
    $(".piropay_signup_form input").on("keydown", function() {
        var e;
        return e = $(this).parents(".piropay_signup_form"), e.removeClass("error"), remove_signup_tooltips()
    }), $(document).on("submit", ".piropay_query_form", null, function(e) {
        var t,
            n,
            i;
    ...
    }), $(document).on("submit", ".piropay_signup_form:not(.piropay_query_form)", null, function(e) {
        var t,
            n,
            i,
            r,
        ...
        if (this.is_valid)
            return !0;
        if (this.is_valid = !1, t = $(this), p = t.data("origin"), t.removeClass("error"), n = t.find("input.email"), f = $.trim(n.val().replace(/[\u200B-\u200D\uFEFF]/g, "")), l = "" === f, o = /^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/, u = o.test(f), m = checkmail(f), t.data("email_bypass") === f && ("undefined" != typeof BigBrain && BigBrain("track", "hp_checkmail_suggestion_rejected", {
            kind: "Original: " + f + " | Suggestion: " + m
        }), m = !1), l)
            t.addClass("error"), shake_signup_form(t), n.focus(), show_signup_tooltip(n, "Please fill in your email address."), "undefined" != typeof ga && ga("send", "event", "Empty email", "Tried signing up with empty email (Origin: " + p + ")", "From page: " + window.location.pathname);
        else if (u)
            if (m)
                t.addClass("error"), n.focus(), t.data("email_bypass", f), v = $("<p/>", {
                    html: "Did you mean&nbsp;"
                }), h = $("<p/>", {
                    text: "?"
                }), r = $("<button/>", {
                    ...
                    text: "" + m
                }), show_signup_tooltip(n, [v, r, h]);
            else {
                try {
                    g = window.localStorage.getItem("template_name")
                } catch (s) {
                    e = s, g = null
                }
                g && (a = t.attr("action"), a.indexOf("?") > 0 && "?" !== a.substr(-1) && -1 === a.indexOf("account_template_id=") && t.attr("action", a + "&amp;account_template_id=" + encodeURIComponent(window.localStorage.getItem("template_name")))), this.is_valid = !0, n.val(f), c = Ladda.create(t.find("button")[0]), c.start(), setTimeout(function() {
                    return t.submit()
                }, 200), d = $("body").attr("data-page-name"), i = {
                    kind: "Origin: " + p,
                    info1: d
                }, "undefined" != typeof BigBrain && BigBrain("track", "hp_account_signup", i), "undefined" != typeof ga && ga("send", "event", "Account Signup", "Origin: " + p, "From page: " + window.location.pathname)
            }
        else
            t.addClass("error"), shake_signup_form(t), n.focus(), show_signup_tooltip(n, "Oops! Please make sure this is a valid email address."), "undefined" != typeof ga && ga("send", "event", "Invalid email", "Tried signing up with invalid email (Origin: " + p + ")", "From page: " + window.location.pathname);
        return !1
    ...
    window.init_video = function(e, t, n) {
        ...
        var n,
            ...
            a,
            l;
        return i = ["/img/customers/90min.jpg", "/img/customers/adidas.jpg", "/img/customers/aol.jpg", "/img/customers/applicaster.jpg", "/img/customers/conduit.jpg", "/img/customers/discovery.jpg", "/img/customers/fiverr.jpg", "/img/customers/ga.jpg", "/img/customers/leverate.jpg", "/img/customers/mythings.jpg", "/img/customers/nbc.jpg", "/img/customers/outbrain.jpg", "/img/customers/raw.jpg", "/img/customers/riskified.jpg", "/img/customers/saatchi.jpg", "/img/customers/samsung.jpg", "/img/customers/soluto.jpg", "/img/customers/spotim2.jpg", "/img/customers/uber.jpg", "/img/customers/wework.jpg", "/img/customers/wix.jpg"],
        ...
        var e,
            t,
            n;
        return e = ["/img/office/1.jpg", "/img/office/2.jpg", "/img/office/3.jpg", "/img/office/4.jpg", "/img/office/5.jpg", "/img/office/6.jpg"], t = 1, (n = function() {
            setTimeout(function() {
                var i;
